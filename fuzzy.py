...
class Cluster:
    ...
    def FuzzyCMeans(self, n_clusters, initial_centers , histogram , max_iter=250, m=2, error=1e-5 ):
        ...
        self.U = membership( histogram , centers)
...
centers=F.FuzzyCMeans(n_clusters = 3, initial_centers=Initial_centers, histogram= F.adapt(F.Histogram(".\Images\Images\T01.JPG")))
print(centers)
print(fcm.centers)